              ...
              Expanded(
                child: trackComments.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemCount: trackComments.length,
                        itemBuilder: (context, index) {
                          final comment = trackComments[index];
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            onSubmitted: (value) async {
                              ...
                              await ref.read(trackDetailControllerProvider(trackId).notifier).addComment(
                                    value.trim(),
