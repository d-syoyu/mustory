...
class _$StoryImpl implements _Story {
  ...
  @override
  String toString() {
    return 'Story(id: $id, trackId: $trackId, authorUserId: $authorUserId, lead: $lead, body: $body, likeCount: $likeCount, isLiked: $isLiked)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, trackId, authorUserId, lead, body, likeCount, isLiked);
...
abstract class _Story implements Story {
  const factory _Story(
      ...
      final int likeCount,
      final bool isLiked}) = _$StoryImpl;
